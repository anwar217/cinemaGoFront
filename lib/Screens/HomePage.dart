import 'dart:convert';
import 'package:cinemamovie/Screens/UserProfileMenu.dart';
import 'package:cinemamovie/Screens/bookingScreen.dart';
import 'package:cinemamovie/Screens/movieDetail.dart';
import 'package:cinemamovie/Screens/profile.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  var movies = [];
  String query = "";
  var categories = ["all", "crime", "animation", "comedy", "action", "arabic", "documentary"];
  ...
  void get_categories() async {
    var res = await get(Uri.parse("http://192.168.1.27:5000/api/categories/getCategories"));
    setState(() {
  ...
  children: [
    ...
    onTap: () {
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) =>UserProfileMenu(),
        ),);
    },
      child: (user.image == "") ? Container() : CircleAvatar(
        ...
        backgroundImage:NetworkImage(user.image),
                            ...
                            Container(
                              ...
                              child: ElevatedButton(
                                ...
                                style: ElevatedButton.styleFrom(
                                  backgroundColor: ((selectedCategorie == categorie) ? Color.fromARGB(255, 255, 213, 0) : const Color(0xFF292B37)),
              ...
              (movies.isEmpty) ? Container() : SingleChildScrollView(
                child: Column(
                    children: movies
                        .where((movie) => (
                          movie["title"].toLowerCase().contains(query.toLowerCase()) &&
                          ((selectedCategorie == "all") ? true : (movie["categorie"].toLowerCase() == selectedCategorie)))
                        )
                        .map((movie) =>
                        Padding(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: ElevatedButton(
                                          onPressed: () {
                                            Navigator.push(
                                                context, MaterialPageRoute(builder: (context) => BookingScreen(movieData: movie)));
